...
func Test_solveDFS(t *testing.T) {
	type args struct {
		board [][]byte
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := solveDFS(tt.args.board); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("solveDFS() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_solveBFS(t *testing.T) {
	type args struct {
		board [][]byte
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := solveBFS(tt.args.board); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("solveBFS() = %v, want %v", got, tt.want)
			}
		})
	}
}
